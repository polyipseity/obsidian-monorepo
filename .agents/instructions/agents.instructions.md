...
- For Copilot/Chat assistant response templates and short examples, see `.agents/instructions/copilot.instructions.md` and the 'Copilot / Chat assistant examples' section in `AGENTS.md`.
